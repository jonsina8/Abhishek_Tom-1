...
API_ID = int(environ.get('API_ID', '29124838')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'd1a293f6fc4c87f59a665f0a68cd607b')  # API Hash from my.telegram.org
...
PICS_URL = (environ.get('PICS', 'https://ibb.co/YBQK3NFw')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://ibb.co/YBQK3NFw https://ibb.co/1YmfcSVq https://ibb.co/YBQK3NFw https://ibb.co/YBQK3NFw')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7436687322 6765929934').split()] # Replace with the actual admin ID(s) to add
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002552925944'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002520793005'))  # Premium logs channel id
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Your_Movie_Link_8')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002520793005")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002520793005")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/nuztnj.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ankij247@ibl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sukwendar:Sukwendarshing@cluster0.m9fnmdq.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Sukwendar") # Database name (default: cluster)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Fakrudin:fakrudin91056289hay@cluster0.5ilhogs.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002520793005'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_downlod09/9")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_downlod09/9")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_downlod09/9")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "6a3fd84018381fe30f7e1cb2e9a41f92abfb2dd8") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "Shortxlinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "6a3fd84018381fe30f7e1cb2e9a41f92abfb2dd8")  # Shortener API key for second website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Your_Movie_Link_8') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Abhikumar7799') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/movies_updet') # Update channel link for the bot
